...
<img style={{ width: `60%`,display:`flex`,margin:`0 auto` }} src={useBaseUrl("img/logo.png")} />

<hr />

- **Company:** Medtronic
- **Project title:** Annotation tool for Image segmentation masks, bounding boxes and classification labels
